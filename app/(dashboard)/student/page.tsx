    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
      <div className="glass-card animate-fade-in">
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
          ...
          <h3 style={{ color: 'var(--primary)', fontWeight: 800 }}>Continue Learning</h3>
        </div>
      ...
      <div className="glass-card animate-fade-in" style={{ animationDelay: '0.1s' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
          ...
          <h3 style={{ color: 'var(--primary)', fontWeight: 800 }}>Achievements</h3>
        </div>
      ...
      <div className="glass-card animate-fade-in" style={{ marginTop: '2rem', animationDelay: '0.2s' }}>
        <h3 style={{ color: 'var(--primary)', fontWeight: 800, marginBottom: '1.5rem' }}>Recommended for You</h3>
